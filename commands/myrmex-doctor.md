...
5. Run `myrmex-state doctor` and report local-state health without creating a real project run.
6. Check memory tool availability without writing a test memory.
