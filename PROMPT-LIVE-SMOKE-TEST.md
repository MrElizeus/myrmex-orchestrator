...
4. Confirm `myrmex-scout`, `myrmex-worker`, `myrmex-verifier`, `myrmex-planner`, `myrmex-plan-critic`, and `myrmex-frontier` are available to `Task`; do not invoke the writer, planner, critic, or verifier.
